...
from cerebromix.tenant_schemas.tests.models import Tenant, NonAutoSyncTenant, DummyModel
from cerebromix.tenant_schemas.utils import (tenant_context, schema_exists,
...
class TenantTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        settings.TENANT_MODEL = 'cerebromix.tenant_schemas.Tenant'
